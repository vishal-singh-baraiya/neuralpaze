...
export function ModelTemplates({ onLoadTemplate, onClose }: ModelTemplatesProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl border border-white/20 rounded-2xl w-full max-w-6xl h-[95vh] flex flex-col shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-white/10">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Model Templates</h2>
              <p className="text-xs text-gray-400">Choose from pre-built neural network architectures</p>
            </div>
          </div>
          <Button
            variant="ghost"
        ...
        <div className="p-4 border-b border-white/10 space-y-3">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-white/5 border-white/20 text-white placeholder:text-gray-500 rounded-lg h-9"
            />
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {filteredTemplates.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h3 className="text-base font-medium text-gray-400 mb-1">No templates found</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredTemplates.map((template) => {
                ...
                return (
                  <div
                    key={template.id}
                    className={`group relative bg-gradient-to-br ${colorClass} backdrop-blur-sm rounded-lg p-4 cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-white/10`}
                  ...
                  >
                    ...
                    <p className="text-xs text-white/80 mb-3 leading-relaxed">{template.description}</p>
        ...
        <div className="p-4 border-t border-white/10 bg-black/20">
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="ghost"
              onClick={onClose}
              className="text-gray-400 hover:text-white hover:bg-white/10 rounded-lg text-sm"
            >
              Close
            </Button>
          </div>
